...
revoke all on function public.everroot_grant_testflight_beta_entitlement() from public;
revoke all on function public.everroot_grant_testflight_beta_entitlement() from anon;
revoke all on function public.everroot_grant_testflight_beta_entitlement() from authenticated;
...
drop trigger if exists everroot_testflight_beta_family_entitlement_after_insert on public.family_groups;
